                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="no-line"></td>
                                                                <td class="no-line"></td>
                                                                <td class="no-line text-center"><strong>Subtotal</strong>
                                                                </td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        <div class="md-3">
                                                            ...
                                                            <input type="date" placeholder="YY-MM-DD" name="date"
                                                                class="form-control example-date-input" id="date">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 form-group" style="margin-top: auto;">
                                                        <div class="md-3">
                                                            <button class="btn btn-info"> Invoice Update </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
