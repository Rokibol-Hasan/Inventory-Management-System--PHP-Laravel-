        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Approved Invoices</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>Invoice No: <span style="background-color:aquamarine">#{{ $invoice->invoice_no }}</span>
                                Date:<span
                                    style="background-color:aquamarine">{{ date('d-m-Y', strtotime($invoice->date)) }}</span>
                            </h4>
                            <a href="{{ route('invoice.pending.list') }}"
                                class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right"> <i
                                    class="fas fa-list"> Pending Invoices </i></a><br><br>
