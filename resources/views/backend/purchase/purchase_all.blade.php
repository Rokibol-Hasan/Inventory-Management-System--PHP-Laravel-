                                ...
                                <tbody>
                                    @foreach ($allPurchase as $key => $item)
                                        <tr>
                                            ...
                                            <td><span class="btn btn-warning">pending</td>
                                            <td>
                                                <a href="{{ route('purchase.delete', $item->id) }}" id="link" class="btn btn-danger sm" title="Delete Data" id="delete"> <i class="fas fa-trash-alt"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
